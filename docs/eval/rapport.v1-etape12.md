...
| Mesure | Valeur | Seuil |
|---|---|---|
| Taux de rejet du validateur | 6 grief(s) sur 42 tour(s) — 0.14/tour | publié |
| Taux de repli | 1 tour(s) sur 42 — 2 % | publié |
| Itérations par tour | 1 à 4 (médiane 3.0) | publié |
| Prises sans aucune valeur livrée | 4 sur 18 | publié |
...
| Appels au modèle par tour client (mesure nº7) | non disponible — 18 prise(s) sur 18 sans `usage` | publié — **figé à l'enregistrement**, voir la note ci-dessous |
| Jetons d'entrée facturés (mesure nº7) | non disponible — 18 prise(s) sur 18 sans `usage` | publié — **figé à l'enregistrement**, voir la note ci-dessous |
| Jetons de sortie (mesure nº7) | non disponible — 18 prise(s) sur 18 sans `usage` | publié — **figé à l'enregistrement**, voir la note ci-dessous |
...
|---|---|---|---|---|---|---|---|---|---|
| besoin_flou | 1 | 3 | 3 | 0 | — | 0 | 0 | 2 à 3 (médiane 3.0) | ✅ |
| besoin_flou | 2 | 3 | 2 | 0 | — | 0 | 0 | 3 | ✅ |
| besoin_flou | 3 | 3 | 2 | 0 | — | 2 | 0 | 2 à 3 (médiane 3.0) | ✅ |
| budget_absent | 1 | 2 | 2 | 0 | oui | 0 | 0 | 2 | ✅ |
| budget_serre | 1 | 2 | 1 | 0 | oui | 2 | 0 | 2 à 3 (médiane 2.5) | ✅ |
| budget_serre | 2 | 2 | 1 | 0 | oui | 0 | 0 | 2 à 4 (médiane 3.0) | ✅ |
...
| sur_specifie | 1 | 2 | — | — | — | 0 | 1 | 2 à 4 (médiane 3.0) | ✅ |
...
|---|---|---|---|---|---|---|
| besoin_flou | 3 | 1 | texte | `montant_non_fourni` | 65 $ | C'est un bon choix, il y a du monde sur ce rayon : 171 écrans au catalogue, de 65 $ à plus de 9000 $ pour les modèles très haut de gamme |
| besoin_flou | 3 | 1 | texte | `montant_non_fourni` | 9000 $ | C'est un bon choix, il y a du monde sur ce rayon : 171 écrans au catalogue, de 65 $ à plus de 9000 $ pour les modèles très haut de gamme |
| budget_serre | 1 | 2 | texte | `valeur_non_fournie` | 120 Hz | Si vous voulez plus de choix, je peux regarder ce qui se passe en assouplissant l'un des deux critères (par exemple accepter 24 pouces, ou redescendre à 120 Hz) — c'est à vous de me dire lequel vous pèse le moins |
